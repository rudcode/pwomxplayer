...
public:
  OMXPlayerVideo();
  ~OMXPlayerVideo();
  bool Open(COMXStreamInfo &hints, OMXClock *av_clock, PwTileMap *tilemap, const CRect& DestRect, bool dump_info, bool deinterlace, bool mpeg, bool hdmi_clock_sync, bool use_thread, float display_aspect);
  bool Close();
  ...
  bool OpenDecoder(bool dump_info);
  bool CloseDecoder();
