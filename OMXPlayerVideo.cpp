...
bool OMXPlayerVideo::Open(COMXStreamInfo &hints, OMXClock *av_clock, PwTileMap *tilemap, const CRect& DestRect, bool dump_info, bool deinterlace, bool mpeg, bool hdmi_clock_sync, bool use_thread, float display_aspect)
{
...
bool OMXPlayerVideo::OpenDecoder(bool dump_info)
{
  ...
  if(!m_decoder->Open(m_hints, m_av_clock, m_tilemap, m_DestRect, dump_info, m_display_aspect, m_Deinterlace, m_hdmi_clock_sync))
  {
    CloseDecoder();
    return false;
  }
